...
import "./Chainlink_Oracle_Lib/LinkTokenReceiver.sol";
import "./Chainlink_Oracle_Lib/ChainlinkRequestInterface.sol";
import "./Chainlink_Oracle_Lib/OracleInterface.sol";
import "./Chainlink_Oracle_Lib/LinkTokenInterface.sol";
import "./Chainlink_Oracle_Lib/WithdrawalInterface.sol";
import "./Chainlink_Oracle_Lib/Ownable.sol";
import "./Chainlink_Oracle_Lib/SafeMathChainlink.sol";

/**
 * @title The Chainlink Oracle contract
 * @notice Node operators can deploy this contract to fulfill requests sent to them
 */
contract DIDOracle is ChainlinkRequestInterface, OracleInterface, Ownable, LinkTokenReceiver, WithdrawalInterface {
  ...
  mapping(address => bool) private authorizedSender;
